...
[Service member system <i class="fa fa-question-circle fa-question-circle-for-service" aria-hidden="true"></i>](https://man.twcc.ai/@twsdocs/howto-service-access-service-zh) is an account management platform; [<ins>TWCC</ins>](https://www.twcc.ai/) a cloud computing services platform. Two platforms connectted using Single Sign On (SSO), users can log in to both platforms with one account.
