...
title: Module-CUDA with NCCL/cuDNN | en
GA: UA-155999456-1
---
...
- Remind that the version after CUDA 11, some libraries may not be compatible with the gcc 4.8.5 provided by CentOS 7 by default. You can refer to the release note support table for use with modules above gcc 7.
