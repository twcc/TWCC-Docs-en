...
# HowTo: Run parallel computing with multi-nodes on containers －AI Benchmark


:::success
<i class="fa fa-star" aria-hidden="true"></i> **Scenario: How to run processes with more than 8 GPUs? How to create TAIWANIA 2 containers? How to submit jobs?**
