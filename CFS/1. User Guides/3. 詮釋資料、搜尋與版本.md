...
* Please folow the **Key;Value** format to enter or edit metadata. Click **ADD** button to add metadata and **UPDATE** button after finishing update.
...
- **Advanced File Search**
    ...
    * Advanced file search can perform a global search on keyword of the dataset. After entering the **Advanced Search** page, the default is **Advanced File Search**, enter the keyword in the search box on the right to search for all files containing this keyword.
...
- **Custom Metadata Search**
    ...
    * Then, enter the conditions to be searched according to the metadata format : key; value.
...
* The system will automatically keep the old version and record different version numbers, storage areas, creation time and other information if there is a dulicate upon uploading file. You may click the **DOWNLOAD** button to download file to local machine.
...
- Please download the old version and re-upload it if you need to restore the file from an old version.
:::
