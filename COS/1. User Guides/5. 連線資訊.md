...
- Enter Third-party Software page to obtain the connection information of shared space, including URL (use SSL): cos.twcc.ai, Access Key and Secret Key.
...
## Private space (Private COS)

- Click "**Private COS**" > "**Third-party Software**" to get connection information of private space, including URL (use SSL): cos.twcc.ai, Access Key and Secret Key.
