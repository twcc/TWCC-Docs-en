...
- [Enable AMP](#Activate-AMP-function) 
...
:::info
Note: Accelerated Linear Algebra (XLA) can optimize TensorFlow computing and accelerate processing speed.
:::
...
:::spoiler ResNet-50 v1.5 Benchmark performance analysis example
::: info 
