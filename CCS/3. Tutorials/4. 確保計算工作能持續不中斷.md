...
:::
- The example is as follows, terminal will return the job ID (job ID = 1 marked with red frame), and the output file of the process will be displayed in the "nohup.out" 
