...
:::spoiler Q4. How to set up automation to return the data in the container to the localhost?

:::info
Please use the container's public port to transfer data with the localhost. The available ports for the container are: 22, 80, and 443.
...
:::spoiler Q3. When the program is running, it is found to be slower than the localhost? 
